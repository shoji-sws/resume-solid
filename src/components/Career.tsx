...
function CareerCard(props: { entry: CareerEntry; index: number }) {
  const [expanded, setExpanded] = createSignal(props.index < 3);
    ...
    <div class="relative pl-8 pb-8 last:pb-0">
      ...
      <div class="bg-surface-700 rounded-xl p-5 hover:shadow-md transition-shadow cursor-pointer">
        <button
          ...
          aria-controls={`career-detail-${props.index}`}
        ...
        <div
          id={`career-detail-${props.index}`}
          class={`career-detail-content overflow-hidden transition-[max-height,opacity] duration-300 ease-in-out ${
